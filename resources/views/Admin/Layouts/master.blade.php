    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('comment.index')}}"><i class="icon-speech"></i> لیست نظرات</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('media.index')}}"><i class="icon-list"></i>لیست فایل ها</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('media.create')}}"><i class="icon-plus"></i> آپلود فایل</a>
                    </li>
                </ul>
            </li>
        {{--<li class="nav-title">--}}
